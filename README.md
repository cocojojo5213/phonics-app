...
[![Version](https://img.shields.io/badge/version-2.0.0-blue.svg)](https://github.com/cocojojo5213/phonics-app)
...
> **如果你使用了本项目的代码、数据或设计，请务必署名！**
> 
> 本项目的**发音规则数据**、**教学内容**、**分词逻辑**均为作者原创整理，花费大量时间和精力。
> 
> **必须署名** - 在你的项目 README、关于页面或首页底部添加：
> ```
...
本项目的自然拼读规则数据来自 [Phonics App](https://github.com/cocojojo5213/phonics-app)。
```
